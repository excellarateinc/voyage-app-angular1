...
This best practices guide is effectively a copy / paste of the Johnpapa Angular 1 Style guide, with only a couple of minor parts removed (i.e. configureing vim for Angular development).
...
## References
[Johnpapa Angular Style Guide](https://github.com/johnpapa/angular-styleguide/blob/master/a1/README.md)
